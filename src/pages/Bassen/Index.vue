...
<div class="kirish-oyna" id="body">
    ...
    <div class="print_check">
        ...
        <div class="check-page" style="width: 100%;">
            <div class="check-page-header"><h2 style="text-align: center;">Тоза ҳаво сиҳатгоҳи</h2></div>
            <div class="check-page-body" style="padding: 12px 35px;">
                <div class="check-page-body_item"> <h2 style="text-align: center;">Бассейн учун тўлов</h2> </div>
    ...
    methods: {
        ...
        chekPrint() {
            if(this.checkSpinner == false){
                ...
                let self = this;
                self.counter.odam_soni = self.counter.odam_soni *1;
                axios({
                method: "post",
                url: "/bassen/kirish",
                data:self.counter,
