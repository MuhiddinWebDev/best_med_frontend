                  ...
                  >
                    <div style="display: flex; margin-right: 15px">
                      <b-button
                        ...
                        @click="medPristavitelLink(row.item.id)"
                        class="pencil"
                      >
                        <b-icon
                          style="width: 15px;"
...
export default {
  ...
  methods: {
    RowClicked(item) {
      this.$router.push({ path: "/medpritavitel-update/" + item.id });
    },
    medPristavitelLink(id) {
      return this.$router.push({ path: "/medpritavitel-update/" + id });
    },
    createRoomLink() {
      return this.$router.push({ path: "/medpritavitel-create" });
    },
    data() {
      let s = this;
      axios({
