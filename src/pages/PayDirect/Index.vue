                  ...
                  >
                    <div style="display: flex; margin-right: 15px">
                      <b-button
                        ...
                        @click="providerPayLink(row.item.id)"
                        class="pencil"
                      >
                        <b-icon
                          style="width: 15px;"
...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        "№",
        { key: "direct.name", label: "Вакил", sortable: true },
  ...
  methods: {
    RowClicked(item) {
      this.$router.push({ path: "/pay-direct/update/" + item.id });
    },
    providerPayLink(id) {
      return this.$router.push({ path: "/pay-direct/update/" + id });
    },
    createRoomLink() {
      return this.$router.push({ path: "/pay-direct/create" });
    },
    data() {
      let s = this;
      axios({
