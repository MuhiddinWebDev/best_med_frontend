...
export default {
  ...
  methods: {
    RowClicked(item) {
      this.$router.push({ path: "/filial-update/" + item.id });
    },
    reagentLink(id) {
      return this.$router.push({ path: "/filial-update/" + id });
    },
    createRoomLink() {
      return this.$router.push({ path: "/filial-create" });
    },
    data() {
      let s = this;
      axios({
